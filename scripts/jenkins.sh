...
docker run --name jenkins-docker --rm --detach \
  ...
  --volume $(pwd)/volumes/jenkins-docker-certs:/certs/client \
  --volume $(pwd)/volumes/jenkins-data:/var/jenkins_home \
  --publish 2376:2376 \
...
docker run --name jenkins-blueocean --restart=on-failure --detach \
  ...
  --volume $(pwd)/volumes/jenkins-data:/var/jenkins_home \
  --volume $(pwd)/volumes/jenkins-docker-certs:/certs/client:ro \
